...
class WordPressCoreInstaller extends LibraryInstaller {
    ...
    public function getInstallPath(PackageInterface $package) {
        ...
        if ($this->composer->getPackage()) {
            ...
            if (!empty($topExtra['public-folder'])) {
                $installationDir = $topExtra['public-folder'];
        ...
        if (!$installationDir && !empty($extra['public-folder'])) {
            $installationDir = $extra['public-folder'];
        }
        if (!$installationDir) {
            $installationDir = 'public';
        }
